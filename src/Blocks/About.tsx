      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-center text-gray-600 max-w-3xl mx-auto">
            ...
            our clients’{" "}
            <strong className="text-secondary font-bold">dreams/visions</strong>{" "}
            in drawings and bring them to the desired reality through
            construction solutions that stands the test of time. We communicate
            with our clients throughout the construction process to keep them
            informed of progress and to ensure that our project keeps on
            ...
            <Card className="h-full bg-white hover:shadow-lg transition-shadow duration-300">
              ...
              <CardContent>
                <p className="text-gray-600 text-lg leading-relaxed">
                  ...
                  possible construction expertise and services whereby public
                  and cooperate world can always rely on
                </p>
              </CardContent>
            </Card>
          </motion.div>
